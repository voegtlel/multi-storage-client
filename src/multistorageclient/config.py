...
class SimpleProviderBundle(ProviderBundle):
    ...
    def __init__(self, storage_provider_config: StorageProviderConfig,
...
class StorageClientConfigLoader:
    ...
    def __init__(self,
        ...
        if DEFAULT_POSIX_PROFILE_NAME not in self._profiles:
            ...
            storage_provider_type = self._profiles[DEFAULT_POSIX_PROFILE_NAME].get(
    ...
    def _build_storage_provider(self, storage_provider_name: str,
    ...
    def _build_credentials_provider(
            self, credentials_provider_dict: Optional[Dict[str, Any]]) -> Optional[CredentialsProvider]:
        """
...
class StorageClientConfig:
    ...
    def __init__(self, profile: str, storage_provider: StorageProvider,
                 credentials_provider: Optional[CredentialsProvider] = None,
                 metadata_provider: Optional[MetadataProvider] = None,
                 cache_config: Optional[CacheConfig] = None, retry_config: Optional[RetryConfig] = None):
    ...
    @staticmethod
    def from_provider_bundle(config_dict: Dict[str, Any],
                             provider_bundle: ProviderBundle) -> 'StorageClientConfig':
