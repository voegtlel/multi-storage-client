...
BASE_MANIFEST_PART_1_LINES = [
    {
        'key': 'dataset_073.tar.idx',
        'size_bytes': 808,
        'last_modified': '2024-08-29T22:43:47.675274Z'
    },
    {
        'key': 'dataset_063.tar.idx',
        'size_bytes': 808,
        'last_modified': '2024-08-29T22:43:47.648609Z'
    }
]
...
BASE_MANIFEST_PART_2_LINES = [
    {
        'key': 'dataset_066.tar',
        'size_bytes': 471040,
        'last_modified': '2024-08-29T22:42:53.556584Z'
    },
    {
        'key': 'dataset_072.tar',
        'size_bytes': 471040,
        'last_modified': '2024-08-29T22:42:53.639584Z'
    }
]
...
def test_file_metadata_and_update():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        manifest = {
            **BASE_MANIFEST,
            'parts': [
                {'path': manifest_part_1_filepath},
                {'path': manifest_part_2_filepath}]
        }
            ...
            'profiles': {
                'default': {
                    'storage_provider': {
                        'type': 'file',
                        'options': {
                            'base_path': f'{data_folderpath}'
                        }
                    },
                    'metadata_provider': {
                        'type': 'manifest',
                        'options': {
                            'manifest_path': os.path.join(tmpdir, manifest_filepath),
                            'writable': True
                        }
                    }
                }
...
def test_download_file_with_metadata(file_storage_config):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        download_test_files(dst_dir_path=dst_data_folderpath,
                            files_metadata=BASE_MANIFEST_PART_1_LINES + BASE_MANIFEST_PART_2_LINES)
